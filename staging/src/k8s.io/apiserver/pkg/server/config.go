...
type Config struct {
	...
	// MaxMetricsRequestsInFlight is the maximum number of parallel requests to /metrics endpoint.
	// Every further request has to wait.
...
func DefaultBuildHandlerChain(apiHandler http.Handler, c *Config) http.Handler {
	...
	handler = genericfilters.WithMaxInFlightLimit(handler, c.MaxRequestsInFlight, c.MaxMutatingRequestsInFlight, c.MaxMetricsRequestsInFlight, c.LongRunningFunc)
