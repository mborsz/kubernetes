...
// NodeAuthorizerSubsystem is a subsystem used by metrics here.
...
// RegisterMetrics registers all node authorizer specific metrics.
func RegisterMetrics() {
	registerMetrics.Do(func() {
		legacyregistry.MustRegister(NodeAuthorizerActionsDuration)
	})
}
